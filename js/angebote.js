...
const PROSPEKTE = [
  {
    ...
    emoji: '🛒',
    title: 'Lidl Frische-Woche',
    subtitle: 'Gültig: 26.03. – 01.04.',
    ...
    sponsored: false,
    deals: [
      { id:'ld1', name:'Mozzarella di Bufala 250g',   price:2.99,  normalPrice:3.99,  unit:'Stk',     category:'Käse',         discount:25 },
      { id:'ld2', name:'Pizzamehl Tipo 00 1kg',        price:0.59,  normalPrice:0.79,  unit:'kg',      category:'Grundzutaten', discount:25 },
      { id:'ld3', name:'Tomatensauce passiert 500ml',  price:0.69,  normalPrice:0.99,  unit:'Dose',    category:'Grundzutaten', discount:30 },
      { id:'ld4', name:'Frische Hefe',                 price:0.29,  normalPrice:0.39,  unit:'Päck.',   category:'Grundzutaten', discount:26 },
      { id:'ld5', name:'Salami Milano 200g',           price:6.49,  normalPrice:null,  unit:'kg',      category:'Belag',        discount:0  },
      { id:'ld6', name:'Peperoni',                     price:4.99,  normalPrice:null,  unit:'kg',      category:'Belag',        discount:0  },
      { id:'ld7', name:'Parmesan gerieben 100g',       price:1.49,  normalPrice:1.99,  unit:'Stk',     category:'Käse',         discount:25 },
      { id:'ld8', name:'Olivenöl nativ extra 500ml',   price:3.49,  normalPrice:4.99,  unit:'Flasche', category:'Grundzutaten', discount:30 },
    ]
  },
  {
    id: 'lidl-kw14',
    ...
    sponsored: false,
    deals: [
      { id:'ld9',  name:'Parmigiano Reggiano 200g',    price:3.29,  normalPrice:4.49,  unit:'Stk',     category:'Käse',         discount:27 },
      { id:'ld10', name:'San Marzano Tomaten 400g',    price:0.79,  normalPrice:0.99,  unit:'Dose',    category:'Grundzutaten', discount:20 },
      { id:'ld11', name:'Prosciutto Crudo 100g',       price:1.99,  normalPrice:2.49,  unit:'Stk',     category:'Belag',        discount:20 },
      { id:'ld12', name:'Rucola 100g',                 price:0.99,  normalPrice:1.29,  unit:'Bund',    category:'Gemüse',       discount:23 },
      { id:'ld13', name:'Cherry-Tomaten 500g',         price:1.49,  normalPrice:1.99,  unit:'Stk',     category:'Gemüse',       discount:25 },
      { id:'ld14', name:'Meersalz 500g',               price:0.39,  normalPrice:0.59,  unit:'Päck.',   category:'Gewürze',      discount:34 },
    ]
  },
  {
    id: 'billa-kw13',
    ...
    sponsored: false,
    deals: [
      { id:'bi1', name:'Salami Milano 200g',           price:6.49,  normalPrice:8.49,  unit:'kg',      category:'Belag',        discount:24 },
      { id:'bi2', name:'Frischer Basilikum',           price:0.79,  normalPrice:0.89,  unit:'Bund',    category:'Gewürze',      discount:11 },
      { id:'bi3', name:'Meersalz 1kg',                 price:0.49,  normalPrice:0.59,  unit:'kg',      category:'Gewürze',      discount:17 },
      { id:'bi4', name:'Mortadella 150g',              price:1.29,  normalPrice:1.79,  unit:'Stk',     category:'Belag',        discount:28 },
      { id:'bi5', name:'Ricotta 250g',                 price:1.19,  normalPrice:1.59,  unit:'Stk',     category:'Käse',         discount:25 },
      { id:'bi6', name:'Gorgonzola 200g',              price:2.49,  normalPrice:3.29,  unit:'Stk',     category:'Käse',         discount:24 },
      { id:'bi7', name:'Weizenbier 6er-Pack',          price:5.99,  normalPrice:7.99,  unit:'Pack',    category:'Getränke',     discount:25 },
    ]
  },
  {
    id: 'metro-maerz',
    ...
    sponsored: true,
    deals: [
      { id:'me1', name:'Olivenöl Extra Vergine 3L',    price:4.29,  normalPrice:5.49,  unit:'Liter',   category:'Grundzutaten', discount:22 },
      { id:'me2', name:'Parmigiano Reggiano 1kg',      price:7.49,  normalPrice:8.99,  unit:'kg',      category:'Käse',         discount:17 },
      { id:'me3', name:'San Marzano Tomaten 2,5kg',    price:3.49,  normalPrice:4.49,  unit:'Dose',    category:'Grundzutaten', discount:22 },
      { id:'me4', name:'Pizzamehl Tipo 00 25kg',       price:18.90, normalPrice:24.90, unit:'Sack',    category:'Grundzutaten', discount:24 },
      { id:'me5', name:'Mozzarella Fior di Latte 1kg', price:4.99,  normalPrice:6.49,  unit:'kg',      category:'Käse',         discount:23 },
      { id:'me6', name:'Prosciutto Crudo 1kg',         price:14.90, normalPrice:18.90, unit:'kg',      category:'Belag',        discount:21 },
      { id:'me7', name:'Basilikum Pesto 500g',         price:3.99,  normalPrice:5.49,  unit:'Glas',    category:'Saucen',       discount:27 },
      { id:'me8', name:'Pizzakarton 33cm 100er',       price:8.90,  normalPrice:11.90, unit:'Pack',    category:'Verpackung',   discount:25 },
      { id:'me9', name:'Frischhaltefolie 300m',        price:12.90, normalPrice:16.90, unit:'Rolle',   category:'Haushalt',     discount:24 },
      { id:'me10',name:'Einweghandschuhe L 100er',     price:4.49,  normalPrice:5.99,  unit:'Pack',    category:'Haushalt',     discount:25 },
    ]
  },
  {
    id: 'hofer-kw13',
    ...
    emoji: '🏷️',
    title: 'Hofer Aktionswoche',
    subtitle: 'Gültig: 27.03. – 02.04.',
    ...
    sponsored: false,
    deals: [
      { id:'ho1', name:'Mozzarella 125g',              price:1.99,  normalPrice:2.49,  unit:'Stk',     category:'Käse',         discount:20 },
      { id:'ho2', name:'Weizenmehl 1kg',               price:0.69,  normalPrice:0.89,  unit:'kg',      category:'Grundzutaten', discount:22 },
      { id:'ho3', name:'Passierte Tomaten 500g',       price:0.79,  normalPrice:0.99,  unit:'Stk',     category:'Grundzutaten', discount:20 },
      { id:'ho4', name:'Kochsalami 400g',              price:2.99,  normalPrice:3.99,  unit:'Stk',     category:'Belag',        discount:25 },
      { id:'ho5', name:'Sonnenblumenöl 1L',            price:1.29,  normalPrice:1.79,  unit:'Flasche', category:'Grundzutaten', discount:28 },
      { id:'ho6', name:'Knoblauch Knolle',             price:0.59,  normalPrice:0.89,  unit:'Stk',     category:'Gewürze',      discount:34 },
    ]
  },
  {
    id: 'spar-kw13',
    ...
    emoji: '🌿',
    title: 'Spar Genuss-Woche',
    subtitle: 'Gültig: 27.03. – 09.04.',
    valid_from: '2026-03-27',
    valid_to: '2026-04-09',
    category: 'Lebensmittel',
    bundesland: 'all',
    sponsored: false,
    deals: [
      { id:'sp1', name:'Parmigiano Reggiano 100g',     price:2.49,  normalPrice:3.29,  unit:'Stk',     category:'Käse',         discount:24 },
      { id:'sp2', name:'Olivenöl nativ extra 750ml',   price:4.99,  normalPrice:6.49,  unit:'Flasche', category:'Grundzutaten', discount:23 },
      { id:'sp3', name:'Burrata 200g',                 price:2.99,  normalPrice:3.99,  unit:'Stk',     category:'Käse',         discount:25 },
      { id:'sp4', name:'Antipasti Mix 200g',           price:3.49,  normalPrice:4.99,  unit:'Glas',    category:'Belag',        discount:30 },
      { id:'sp5', name:'Focaccia-Brot',                price:1.99,  normalPrice:2.49,  unit:'Stk',     category:'Bäckerei',     discount:20 },
      { id:'sp6', name:'Trüffelöl 100ml',              price:4.99,  normalPrice:6.99,  unit:'Flasche', category:'Grundzutaten', discount:29 },
      { id:'sp7', name:'Pinienkerne 100g',             price:2.29,  normalPrice:2.99,  unit:'Tüte',    category:'Sonstiges',    discount:23 },
      { id:'sp8', name:'San Pellegrino 6×0,75L',       price:4.49,  normalPrice:5.99,  unit:'Pack',    category:'Getränke',     discount:25 },
    ]
  },
  {
    id: 'penny-kw14',
    ...
    sponsored: false,
    deals: [
      { id:'pe1', name:'Salami Milano 300g',           price:5.99,  normalPrice:7.49,  unit:'Stk',     category:'Belag',        discount:20 },
      { id:'pe2', name:'Frische Hefe',                 price:0.35,  normalPrice:0.45,  unit:'Päck.',   category:'Grundzutaten', discount:22 },
      { id:'pe3', name:'Gouda jung 400g',              price:2.49,  normalPrice:3.19,  unit:'Stk',     category:'Käse',         discount:22 },
      { id:'pe4', name:'Ketchup 500ml',                price:0.99,  normalPrice:1.39,  unit:'Flasche', category:'Saucen',       discount:29 },
      { id:'pe5', name:'Oregano getrocknet 20g',       price:0.59,  normalPrice:0.89,  unit:'Päck.',   category:'Gewürze',      discount:34 },
    ]
  },
];
